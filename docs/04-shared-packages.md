...
| DTO                                                                      | 위치                   | 주요 필드                                                                                                                                  |
| ------------------------------------------------------------------------ | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `ProjectDTO`                                                             | `src/index.ts:172-179` | `id, userId, name, thumbnail?, createdAt, updatedAt`                                                                                       |
| `PageDTO`                                                                | `src/index.ts:155-164` | `id, projectId, order, name(null이면 'p{order+1}'), size{w,h}, background?`                                                                |
| `PanelDTO`                                                               | `src/index.ts:118-131` | `id, pageId, shape, conti?, text(TipTapDoc), refImages, currentRenderId?, currentRenderStatus?, currentRenderImageUrl?, history[]`         |
