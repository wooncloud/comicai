...
**Gemini 3.1 flash image preview (gemini-3.1-flash-image-preview) 및 GPT-image-2**를 사용한다. Stable Diffusion / IP-Adapter / ControlNet / LoRA 등 SD 계열 기법은 본 프로젝트에서 사용하지 않는다.
