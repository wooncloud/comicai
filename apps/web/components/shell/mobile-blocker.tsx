 ...
 *
 * 폭만 보던 `md:hidden` 으로는 부족했다: 폰을 가로로 눕히면 폭이 768px 을 넘어
...
export function MobileBlocker({ backHref = '/dashboard' }: { backHref?: string }) {
  return (
    <div
      id="mobile-blocker"
      className="fixed inset-0 z-[100] flex flex-col items-center justify-center gap-4 bg-background px-6 text-center [@media(min-width:768px)_and_(min-height:600px)]:hidden"
      role="alertdialog"
